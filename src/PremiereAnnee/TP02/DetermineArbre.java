public class DetermineArbre {
	...
	/**
	 * Ce programme illustre l'utilisation du type booléen dans des instructions conditionnelles.
	 * Il permet d'identifier un arbre à partir d'observations (feuilles simples ou pas, alternées, etc) ; 
	 * Les observations sont codées sous forme de constantes de type booléen. La valeur d'une constante n'est pas modifiée durant l'exécution du programme.
	 * Nous supposons que la forêt observée est constituée uniquement d'Erables, de Chênes, de Charmes, de Tilleuls et de Frênes.
	 * Les rêgles utilisées sont une simplification de celles proposées par l'ONF à l'adresse :
	...
	public static void main(String[] args) {
        ...
        final boolean FLEURS_ODORANTES = true;
